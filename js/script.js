...
const observer = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            // Only update if menu is NOT open (menu handles its own logo state)
